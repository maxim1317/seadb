...
"}")
        ...
        self.ships_tab = QtWidgets.QWidget()
        self.ships_tab.setObjectName("ships_tab")
        self.verticalLayoutWidget = QtWidgets.QWidget(self.ships_tab)
        self.verticalLayoutWidget.setGeometry(QtCore.QRect(0, 190, 1051, 145))
        ...
        self.tabWidget.addTab(self.ships_tab, "")
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.ships_line_edit.setText(_translate("MainWindow", "Enter here..."))
        self.ships_ok.setText(_translate("MainWindow", "OK"))
        self.tabWidget.setTabText(self.tabWidget.indexOf(self.ships_tab), _translate("MainWindow", "Vessels"))
